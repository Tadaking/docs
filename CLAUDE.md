...
| `do-card` / `dont-card` / `caution-card` | Do/Don't/Caution カード（上部カラーバー + 薄背景） | `typography.mdx` |
| `do-dont-label` | ✅/❌/⚠️ のラベル行 | `typography.mdx` |
| `do-dont-caption` | Do/Don't の説明キャプション | `typography.mdx` |
| `do-dont-preview` | プレビュー画像エリア | `typography.mdx` |
...
| `type-preview-select` | 行間切り替えドロップダウン | `typography.mdx` |
| `typescale-switcher` | Standard/Comfortable タブ切り替え | `typography.mdx` |
